...
typedef Widget ChildBuilder<T>(BuildContext context, List<T> values);
...
class DropdownSearch<T> extends StatefulWidget {
  ...
  /// this allow to custom child widget
...
class DropdownSearchState<T> extends State<DropdownSearch<T>> {
        ...
        return IgnorePointer(
          ...
          child: InkWell(
            ...
            child: widget.childBuilder != null
                ? widget.childBuilder!(context, _selectedItemsNotifier.value)
                : _formField(),
          ),
        );
      },
  ...
  Widget _popupWidgetInstance() {
    return SelectionWidget<T>(
      /// key: _popupStateKey, /// remove to avoid duplicate global key error
